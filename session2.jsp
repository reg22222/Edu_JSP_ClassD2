...
String m_name = (String)sess.getAttribute("name");
String m_addr = (String)sess.getAttribute("addr");
String m_phone = (String)sess.getAttribute("phone");*/
	//out.println("name["+m_name+"]");
	//out.println("addr["+m_addr+"]");
